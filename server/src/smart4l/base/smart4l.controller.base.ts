...
export class Smart4lControllerBase {
  constructor(
  ...
  @swagger.ApiCreatedResponse({ type: Smart4l })
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async create(
    @common.Body() data: Smart4lCreateInput,
  ...
  @swagger.ApiOkResponse({ type: [Smart4l] })
  @swagger.ApiForbiddenResponse()
  @ApiNestedQuery(Smart4lFindManyArgs)
  async findMany(
    @common.Req() request: Request,
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<Smart4l[]> {
    const args = plainToClass(Smart4lFindManyArgs, request.query);
  ...
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async findOne(
    @common.Param() params: Smart4lWhereUniqueInput,
    @nestAccessControl.UserRoles() userRoles: string[]
